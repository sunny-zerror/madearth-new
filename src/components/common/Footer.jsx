  ...
  return (
    <>
      <div className='w-full pt-20 pb-10  padding'>
        ...
        <div className="w-full h-[80vh] space-y-32">
        ...
        <div className="flex gap-2 items-center font-semibold text-3xl">
          <p>Work with us</p>
          <RiArrowRightLine />
        </div>
      ...
      <div className="seq_parent w-full center h-screen relative">
        <img ref={imgRef} src={images[0]} className="h-full absolute" />
      </div>
    </>
  );
};
